...
\begin{itemize}
\item Our CSs hold non-asymptotically, unlike all existing CIs mentioned above which are asymptotically valid.
...
\item Our validity guarantees are time-uniform, meaning that they remain valid under optional continuation (collecting more data) and/or at stopping times, both of which are not true for all aforementioned confidence intervals.
\end{itemize}
...
We begin here with a Follow-The-Leader
...
asymptotic confidence interval from~\citet{karampatziakis2019empirical}
