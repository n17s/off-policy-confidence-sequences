...
Recently, \cite{kallus} has proposed an OPE estimator that uses
...
\com{\quad\quad\quad Nikos:\\ \quad\quad\quad shorter bullets}
\begin{itemize}
...
While these optimizations seem complicated and 
